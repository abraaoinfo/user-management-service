...
public class UserController implements UserApi {
    ...
    public ResponseEntity<User.UserRecord> createUser(@RequestBody User.CreateUserRequest request) {
        ...
        return userRecord.map(record ->
                ResponseEntity.status(HttpStatus.CREATED)
                        .body(record)).orElseGet(() -> ResponseEntity.status(HttpStatus.CONFLICT).build());
    ...
    public ResponseEntity<User.UserRecord> getUserById(@PathVariable Long id) {
        ...
        return userRecord.map(ResponseEntity::ok).orElseGet(()
    ...
    public ResponseEntity<User.UserRecord> updateUser(@PathVariable Long id,
        ...
        return userRecord.map(ResponseEntity::ok)
    ...
    public java.util.concurrent.CompletableFuture<ResponseEntity<String>> processBatchUsers(@RequestBody List<User.CreateUserRequest> requests) {
    ...
    public java.util.concurrent.CompletableFuture<ResponseEntity<String>> validateAddresses(@RequestBody List<String> postalCodes) {
